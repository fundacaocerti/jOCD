...
public class Flash {
     ...
     */
    public ProgrammingInfo flashBlock(long address, byte [] data, boolean smartFlash, boolean chipErase,
                             ProgressUpdateInterface progressUpdate, boolean fastVerify) {
